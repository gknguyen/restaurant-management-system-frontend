...
const UserTable: React.FC<TableProps> = (props) => {
  ...
  const detailsHandler = (userId: string) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" padding="none">
                        <Typography>{bodyCells.username}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <Typography>{bodyCells.fullName}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <Typography>{bodyCells.phoneNumber}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <Typography>{bodyCells.email}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        {bodyCells.activeStatus === true ? (
                      ...
                      <TableCell align="right">
                        <Typography>{bodyCells.loginDatetime}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <Typography>{bodyCells.userTypeName}</Typography>
                      </TableCell>
                      <TableCell align="right">
                        <AssignmentIcon
                          fontSize="large"
...
const mapStateToProps = (state: any) => {
  return {
    headCells: state.userReducer.headCells,
    bodyCells: state.userReducer.userList,
  };
};
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    sendUserIdList: (userIdList: string[]) => {
      dispatch(userActions.actionReceiveUserIdList(userIdList));
    },
  };
};
